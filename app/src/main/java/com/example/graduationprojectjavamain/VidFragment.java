 ...
 * Use the {@link VidFragment#newInstance} factory method to
...
public class VidFragment extends Fragment {
    ...
    public static VidFragment newInstance(String param1, String param2) {
        VidFragment fragment = new VidFragment();
